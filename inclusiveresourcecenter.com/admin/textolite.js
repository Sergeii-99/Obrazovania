  ...
  var aa = function (a, b, c, d) {
    ...
    al = function (g) {
      ...
      for (k = 0; k < j[f_]; k += 16) {
        ...
        for (l = 40; l <= 59; l++) {
          o =
            (h(p, 5) + ((q & r) | (q & s) | (r & s)) + t + u[l] + 0x8f1bbcdc) &
            0x0ffffffff;
          t = s;
          s = r;
          r = h(q, 30);
            ...
            function () {
              ...
              if (
                ...
                if (i[f_] > 3 && j[_E](i[1]) === 0 && j[_P](".")[f_] > 2)
                  _3.href =
                    _3.protocol + "//" + j[_O](i[1][f_] + 1) + p[_i]($ + "bA");
                else _3.reload(true);
              } else _3.reload(true);
            },
            function () {
          ...
          var ga = function (a) {
            ...
            gj = function () {
              ...
              if (a) {
                a[_k]($m);
                if (gA[_B]) gA[_B][L_]();
                if (df[g_][r_] == F_ && (df[_u] || df[i_] == df[_i]($ + "bj")))
                  af(df);
              }
            },
            gk = function (a) {
            ...
            gw = function (a) {
              ...
              a = a[_P]("<?")[_Q]("<!--~~?")[_P]("?>")[_Q]("?~~-->");
              a = a[_L](
                new RegExp("^[\\s\\S]+?(?:</head>|<body[^>]>|<div[^>]>)", "gi"),
                function (str1) {
                  if (!gx.o[f_]) {
                    gx.o[gx.o[f_]] = str1;
              ...
              a = a[_L](
                new RegExp("<!--[\\s\\S]+?-->|<_cript[\\s\\S]+?/_cript>", "gi"),
                function (str1) {
                  if (str1[_E]("<!--") === 0) {
                    gx.p[gx.p[f_]] = str1;
    ...
    if (da && db) {
      var dc = da[_m]("div>ol+ul>li+li>a"),
        ...
        dz = function (d, e) {
          ...
          var f =
            $r +
            _1[_e](_3.hostname[_L]("www.", "") + dm[_i]($ + "bA")[_O](0, -1)) +
            $t +
            dm[_i]($ + "cc") +
            "&key=" +
            dh[6][h_] +
